export default function ClipboardIcon (props:{onClick:()=>void}) {
  return <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline-block align-sub cursor-pointer">
